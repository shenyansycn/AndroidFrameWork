...
import org.android.flipview.utils.TextureUtils;
import org.android.flipview.utils.UI;
    ...
    public synchronized void buildTexture(FlipRenderer renderer, GL10 gl) {
        if (screenshot != null) {
            ...
            if (orientationVertical) {
                ...
                bottomCard.setTextureCoordinates(new float[]{0f, viewHeight / 2f / textureHeight, 0f, viewHeight / textureHeight,
                        viewWidth / textureWidth, viewHeight / textureHeight, viewWidth / textureWidth, viewHeight / 2f / textureHeight});
            } else {
                topCard.setCardVertices(new float[]{0f, viewHeight, 0f, // top
                        // left
                        0f, 0f, 0f, // bottom left
                ...
                topCard.setTextureCoordinates(new float[]{0f, 0f, 0f, viewHeight / textureHeight, viewWidth / 2f / textureWidth,
                ...
                bottomCard.setTextureCoordinates(new float[]{viewWidth / 2f / textureWidth, 0f, viewWidth / 2f / textureWidth,
                        viewHeight / textureHeight, viewWidth / textureWidth, viewHeight / textureHeight, viewWidth / textureWidth, 0f});
            }
