...
class ImageCache {
    ...
    /**
     * Return an {@link ImageCache} instance. A is used to retain the
     * ImageCache object across configuration changes such as a change in device orientation.
     *
     * @param cacheParams The cache parameters to use if the ImageCache needs instantiation.
     * @return An existing retained ImageCache object or a new one if one did not exist
     */
    static ImageCache getInstance(ImageCacheParams cacheParams) {
     ...
     * executed on the demo_template_picker/UI thread. By default an ImageCache does not initialize the disk
     ...
     * this includes disk access so this should not be executed on the demo_template_picker/UI thread.
     */
     ...
     * disk access so this should not be executed on the demo_template_picker/UI thread.
     */
    public void flush() {
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
