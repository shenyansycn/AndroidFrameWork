 ...
 * memory.
 * 一个简单的针对制定的图片宽和高进行缩放的ImageWorker的子类。通常用于大图片直接导入到内存中。
 */
class ImageResizer extends ImageWorker {
    ...
    /**
     * The demo_template_picker processing method. This happens in a background task. In this case we are just
