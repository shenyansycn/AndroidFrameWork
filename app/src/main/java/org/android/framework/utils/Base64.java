...
public class Base64 {
    ...
    final static char[] encodeToChar(byte[] sArr) {
    ...
    final static byte[] encodeToByte(byte[] sArr) {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        String str = Base64.encodeToString("qqqqqq".getBytes());
        System.out.println(str);
        System.out.println(new String(Base64.decode(str.getBytes()), "UTF-8"));
    }
