package org.android.widget.pulltorefresh;
...
public class PullToRefreshRelativeLayout extends RelativeLayout {
    ...
    private void addHeaderView() {
        // header view
        mHeaderView = mInflater.inflate(R.layout.org_widget_pulltorefresh_refresh_header, this, false);
    ...
    private void addFooterView() {
        // footer view
        mFooterView = mInflater.inflate(R.layout.org_widget_pulltorefresh_refresh_footer, this, false);
        ...
        params.setMargins(0, 0, 0, -mFooterViewHeight);// 分别是margin_top那四个属性;
        // int top = getHeight();
        // params.topMargin
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mPullState == PULL_DOWN_STATE) {
                    ...
                    Log.i(TAG, " pull down!parent view move! deltaY:" + deltaY + "Y" + y);
                    headerPrepareToRefresh(deltaY);
                    // setHeaderPadding(-mHeaderViewHeight);
                } else if (mPullState == PULL_UP_STATE) {
                    // PullToRefreshView执行上拉
                    Log.i(TAG, "pull up!parent view move! deltaY:" + deltaY + "Y" + y);
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (mPullState == PULL_DOWN_STATE) {
                    ...
                    if (bottomMargin >= 0 && !mLock_footer) {
                        // 开始执行footer 刷新
                        footerRefreshing();
                        lockFooter();
                        lock();
                        ...
                        // 还没有执行刷新，重新隐藏
                        setFooterBottomMargin(-mHeaderViewHeight);
                    }
                }
                break;
        }
    ...
    /**
     * footer 准备刷新,手指移动过程,还没有释放 移动footer
     *
     * @param deltaY ,手指滑动的距离
     */
    private void footerPrepareToRefresh(int deltaY) {
        if (mOnFooterRefreshListener == null || mLock_footer) {
            return;
        }
        int newTopMargin = changingFooterViewTopMargin(deltaY);
        // 说明footer view 完全显示出来了，修改footer view 的提示状态
        if (newTopMargin >= 0 && mFooterState != RELEASE_TO_REFRESH) {
    ...
    private int changingHeaderViewTopMargin(int deltaY) {
        ...
        params.topMargin = (int) (newTopMargin > 0 ? 0 : newTopMargin);
        mHeaderView.setLayoutParams(params);
        invalidate();
        return params.topMargin;
    }

    private int changingFooterViewTopMargin(int deltaY) {
        LayoutParams params = (LayoutParams) mFooterView.getLayoutParams();
        float newTopMargin = params.bottomMargin - deltaY * 0.3f;
        if (deltaY < 0 && mPullState == PULL_UP_STATE && params.bottomMargin > 0) {
            return params.bottomMargin;
        }
        params.bottomMargin = (int) (newTopMargin > 0 ? 0 : newTopMargin);
    ...
    private void setFooterBottomMargin(int bottomMargin) {
        LayoutParams params = (LayoutParams) mFooterView.getLayoutParams();
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderImageView.setImageResource(R.drawable.org_widget_pulltorefresh_arrow);
        mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
        mHeaderProgressBar.setVisibility(View.GONE);
        String dateString = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis());
        mHeaderUpdateTextView.setText(dateString);
        mHeaderState = PULL_TO_REFRESH;
    }
    ...
    public void onFooterRefreshComplete() {
        setFooterBottomMargin(-mFooterViewHeight);
        mFooterImageView.setVisibility(View.VISIBLE);
        mFooterImageView.setImageResource(R.drawable.org_widget_pulltorefresh_arrow_up);
        mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
    ...
    public interface OnFooterRefreshListener {
        public void onFooterRefresh(PullToRefreshRelativeLayout view);
    }
    ...
    public interface OnHeaderRefreshListener {
        public void onHeaderRefresh(PullToRefreshRelativeLayout view);
    }
}
